...
export const SuggestiveSearch: React.FC<SuggestiveSearchProps> = ({
  ...
  className,
  Leading = () => <Search className="size-4 text-secondary" />,
  showLeading = true,
  Trailing = () => <Search className="size-4 text-secondary" />,
  showTrailing = false,
  effect = "typewriter",
  EffectComponent,
  typeDurationMs = 500,
  ...
  return (
    <div
      ref={wrapperRef}
      className={cn(
        "relative flex items-center gap-x-2 py-2 px-4 border-b border-primary",
        className
      )}
      style={{ maxWidth: "100%" }}
    >
      ...
      <input
        ...
        onKeyDown={onKeyDown}
        className="bg-transparent outline-none text-sm text-primary placeholder:text-transparent w-full"
        placeholder=""
        aria-label="search"
        style={
          minWidthPx != null
